...
13. 目标数据库先收敛为 6 张表：模型、Session、Turn、Message 和 Trace，加 Migration 表。
...
3. [03-database-schema.md](03-database-schema.md)：不做中途恢复时的 6 表 PostgreSQL Schema。
