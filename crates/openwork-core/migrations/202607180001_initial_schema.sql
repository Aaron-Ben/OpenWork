...
CREATE TABLE models (
    ...
    CONSTRAINT models_provider_kind_not_blank CHECK (btrim(provider_kind) <> ''),
...
CREATE TABLE trace_spans (
    ...
    CONSTRAINT trace_spans_turn_sequence UNIQUE (turn_id, sequence),
    CONSTRAINT trace_spans_kind_valid CHECK (kind IN ('model_call', 'tool_call')),
