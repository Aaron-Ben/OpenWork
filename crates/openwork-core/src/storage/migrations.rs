pub(crate) const LEGACY_SHORT_MIGRATION_VERSION: i64 = 2_026_071_801;
pub(crate) const MIGRATION_VERSION: i64 = 202_607_180_101;
...
pub(crate) const STATEMENTS: &[&str] = &[
    ...
    "#,
    r#"
    CREATE UNIQUE INDEX IF NOT EXISTS uq_models_v2_endpoint_credential
        ON models_v2(provider_kind, base_url, model_name, COALESCE(credential_ref, ''))
    "#,
    r#"
    CREATE INDEX IF NOT EXISTS idx_models_v2_enabled_name
    ...
    "#,
    r#"
    CREATE INDEX IF NOT EXISTS idx_sessions_v2_status_updated
        ON sessions_v2(status, updated_at DESC, id)
    "#,
    r#"
    CREATE INDEX IF NOT EXISTS idx_sessions_v2_default_model
    ...
    "#,
    r#"
    CREATE UNIQUE INDEX IF NOT EXISTS uq_turns_v2_one_running_per_session
        ON turns_v2(session_id) WHERE status = 'running'
    "#,
    r#"
    CREATE INDEX IF NOT EXISTS idx_turns_v2_session_sequence
    ...
    "#,
    r#"
    CREATE INDEX IF NOT EXISTS idx_messages_v2_session_sequence
        ON messages_v2(session_id, sequence)
    "#,
    r#"
    CREATE UNIQUE INDEX IF NOT EXISTS uq_messages_v2_tool_result
        ON messages_v2(turn_id, provider_call_id) WHERE role = 'tool'
    "#,
    r#"
    CREATE TABLE IF NOT EXISTS trace_spans_v2 (
        id                      TEXT PRIMARY KEY,
    ...
    "#,
    r#"
    CREATE INDEX IF NOT EXISTS idx_trace_spans_v2_turn_sequence
