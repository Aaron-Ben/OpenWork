use openwork_protocol::capability::{CapabilityRiskHint, CapabilitySpec};
use serde_json::{Value, json};

pub(crate) fn builtin_specs() -> Vec<CapabilitySpec> {
    vec![
        spec(
            "read",
        ...
        spec(
            ...
            CapabilityRiskHint::WorkspaceMutation,
        ),
        spec(
            "edit",
        ...
        spec(
            ...
            CapabilityRiskHint::ProcessExecution,
        ),
    ]
}
