export const zhTW = {
  ...
  settings: {
    ...
    models: {
      ...
      form: {
        ...
        capabilities: '模型能力', contextWindowTokens: '上下文視窗 Token', maxOutputTokens: '最大輸出 Token',
        maxReasoningTokens: '最大推理 Token', acceptsDataBlocks: '接受圖片及其他資料區塊', optional: '選填',
        ...
        contextWindowTokensInvalid: '模型 {{model}}：上下文視窗 Token 必須是正整數',
        maxOutputTokensInvalid: '模型 {{model}}：最大輸出 Token 必須是正整數',
        maxReasoningTokensInvalid: '模型 {{model}}：最大推理 Token 必須留空或填寫非負整數',
        generationReservationExhaustsWindow: '模型 {{model}}：最大輸出 Token + 最大推理 Token 必須小於上下文視窗 Token',
  ...
  collab: {
    ...
    triage: {
      title: '喚醒裁決模型',
      description: '選擇一個已啟用的 OpenWork 模型來判斷是否需要喚醒同事；儲存後從下一次裁決起生效，無需重新啟動。',
      unconfigured: '尚未配置：triage 會 fail-open，待處理訊息將直接喚醒同事。',
      current: '目前：{{provider}} / {{model}}', provider: '供應商', model: '模型',
      configured: '已配置', failOpen: 'Fail-open', save: '儲存', saving: '儲存中…',
      noModels: '沒有已啟用的供應商/模型，請先到工作臺設定中配置。',
      errorSummary: '裁決設定暫時無法使用，查看技術詳情',
    },
    approvals: {
    ...
    boards: {
      title: '共享看板', createBoard: '新增看板', createColumn: '新增欄', createCard: '新增卡片', noRoom: '先建立或選擇一個房間',
      noBoard: '這個房間還沒有看板', noCards: '暫無卡片', cardTitle: '標題',
      boardTitle: '看板標題', columnTitle: '欄標題', doneColumn: '完成欄',
      doneColumnHint: '卡片移入此欄後計為已完成。',
