export const zhTW = {
  ...
  tool: {
    ...
    permission: {
      ...
      allowedByBuiltin: '內建規則已放行', allowedByRule: '規則已放行', allowedBySessionGrant: '工作階段授權已放行', allowedByMode: '目前模式已放行', allowedByReadonlyProof: '唯讀證明已放行', sensitivePath: '受保護位置，目前模式無法覆蓋',
