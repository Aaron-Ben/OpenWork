export const zhCN = {
  ...
  collab: {
    ...
    triage: {
      title: '唤醒裁决模型',
      description: '选择一个已启用的 OpenWork 模型来判断是否需要唤醒同事；保存后从下一次裁决起生效，无需重启。',
      unconfigured: '尚未配置：triage 会 fail-open，待处理消息将直接唤醒同事。',
      current: '当前：{{provider}} / {{model}}', provider: '服务商', model: '模型',
      configured: '已配置', failOpen: 'Fail-open', save: '保存', saving: '保存中…',
      noModels: '没有已启用的服务商/模型，请先到工作台设置中配置。',
      errorSummary: '裁决设置暂时不可用，查看技术详情',
    },
    approvals: {
    ...
    boards: {
      title: '共享看板', createBoard: '新建看板', createColumn: '添加列', createCard: '新建卡片', noRoom: '先创建或选择一个房间',
      noBoard: '这个房间还没有看板', noCards: '暂无卡片', cardTitle: '标题',
      boardTitle: '看板标题', columnTitle: '列标题', doneColumn: '完成列',
      doneColumnHint: '卡片移入此列后计为已完成。',
