export const enUS = {
  ...
  collab: {
    ...
    triage: {
      title: 'Wake-up triage model',
      description: 'Choose the enabled OpenWork model that decides whether a teammate should wake. Changes apply to the next decision without a restart.',
      unconfigured: 'Not configured: triage is fail-open, so pending messages wake the teammate directly.',
      current: 'Current: {{provider}} / {{model}}', provider: 'Provider', model: 'Model',
      configured: 'Configured', failOpen: 'Fail-open', save: 'Save', saving: 'Saving…',
      noModels: 'No enabled provider/model is available. Configure one in Workbench Settings first.',
      errorSummary: 'Triage settings are temporarily unavailable. Show technical details',
    },
    approvals: {
    ...
    boards: {
      title: 'Shared boards', createBoard: 'Create board', createColumn: 'Add column', createCard: 'Create card', noRoom: 'Create or select a room first',
      noBoard: 'This room has no board yet', noCards: 'No cards', cardTitle: 'Title',
      boardTitle: 'Board title', columnTitle: 'Column title', doneColumn: 'Done column',
      doneColumnHint: 'Cards moved here count as completed work.',
