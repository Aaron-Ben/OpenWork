export const zhCN = {
  ...
  tool: {
    ...
    permission: {
      ...
      allowedByBuiltin: '内置规则已放行', allowedByRule: '规则已放行', allowedBySessionGrant: '会话授权已放行', allowedByMode: '当前模式已放行', allowedByReadonlyProof: '只读证明已放行',
      explicitAsk: '显式规则要求审批', sensitivePath: '受保护位置，当前模式不能覆盖',
