  ...
  settings: {
    ...
    models: {
      ...
      form: {
        ...
        baseUrl: 'API 位址', apiKey: 'API 金鑰', protocol: '協定', showApiKey: '顯示 API 金鑰', hideApiKey: '隱藏 API 金鑰',
        liteModels: 'Lite 模型', liteHint: '快速或低成本模型，以逗號分隔', plusModels: 'Plus 模型', plusHint: '均衡模型，以逗號分隔',
        proModels: 'Pro 模型', proHint: '高能力模型，以逗號分隔', extraBody: '附加請求參數',
        extraBodyHint: '選填，將此 JSON 物件合併至請求本文', test: '測試', testing: '正在測試', connectivityOk: '連線成功', save: '儲存',
        nameRequired: '請輸入名稱', baseUrlRequired: '請輸入 API 位址', apiKeyRequired: '請輸入 API 金鑰',
