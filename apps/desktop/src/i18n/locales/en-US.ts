export const enUS = {
  ...
  tool: {
    ...
    permission: {
      ...
      allowedByBuiltin: 'Allowed by built-in rule', allowedByRule: 'Allowed by rule', allowedBySessionGrant: 'Allowed by session grant', allowedByMode: 'Allowed by current mode', allowedByReadonlyProof: 'Allowed by read-only proof',
