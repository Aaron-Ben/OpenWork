export const enUS = {
  ...
  activity: {
    ...
    traceValues: {
      ...
      policy: 'Policy', config: 'Configuration', builtin: 'Built-in', rule: 'Rule', readonly_proof: 'Read-only proof',
  ...
  tool: {
    ...
    permission: {
      ...
      allowedByBuiltin: 'Allowed by built-in rule', allowedByMode: 'Allowed by current mode', allowedByReadonlyProof: 'Allowed by read-only proof',
